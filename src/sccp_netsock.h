...
SCCP_API void * SCCP_CALL sccp_netsock_thread(void *ignore);	/* review 2026-09: declared, defined nowhere - the single receive thread of the old design; today each session has its own thread plus accept_thread */
__END_C_EXTERN__
